...
export const HomeIntro = () => {
  return (
    <section className=" w-full px-2.5 pb-2.5 h-screen ">
      <div className="rounded-2xl relative w-full h-full bg-neutral-700 bg-dot-white/[0.2] flex flex-col md:flex-row items-center">
        <div className="absolute rounded-2xl pointer-events-none inset-0 flex items-center justify-center  bg-neutral-700 [mask-image:radial-gradient(ellipse_at_center,transparent_50%,white)]"></div>

        <div className="w-2/3 p-20">
          <TextGenerateEffect
            words="How can I help you?"
            className="mb-5 underline text-4xl font-semibold text-white"
          />
          <TextGenerateEffect
        ...
        <div className="w-1/3 flex flex-row flex-wrap gap-5 pr-20">
